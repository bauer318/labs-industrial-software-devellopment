...
public class MedicinalHerb {
    ...
    @Size(min=5,max=35,message="Название должно содержать от 5 до 35 символов")
    @Column(name = "herb_name")
    private  String name;

    @NotEmpty(message="Вид рода не должен быть пустым")
    @Size(min=5,max=35,message="Вид рода должен содержать не менее 5 символов")
    ...
    @Size(min=7,max=35,message="Семейство должно содержать от 7 до 35 символов")
    ...
    @Size(min=5,max=35,message="Распронение должно содержать не менее 5 символов")
