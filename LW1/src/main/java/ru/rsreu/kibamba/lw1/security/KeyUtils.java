package ru.rsreu.kibamba.lw1.security;
...
public class KeyUtils {
    ...
    private String accessTokenPrivateKeyPath = "access-refresh-token-keys/access-token-private.key";

    private String accessTokenPublicKeyPath = "access-refresh-token-keys/access-token-public.key";


    private String refreshTokenPrivateKeyPath = "access-refresh-token-keys/refresh-token-private.key";


    private String refreshTokenPublicKeyPath =  "access-refresh-token-keys/refresh-token-public.key";
